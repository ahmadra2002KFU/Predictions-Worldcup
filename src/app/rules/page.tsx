      ...
      <section className="mt-8 space-y-3">
        ...
        <ul className="list-inside list-disc space-y-2 text-brand-900/80">
          ...
          <li>
            ...
            دقيقة): من توقع الفريق المتأهل وبفارق هدف واحد في توقعه يحصل على نقطتين، ومن توقع الفريق
            المتأهل بفارق أكبر أو توقع تعادلاً يحصل على نقطة واحدة، ومن توقع الفريق الخاسر لا يحصل على شيء.
          </li>
