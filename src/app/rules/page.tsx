    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <section className="mt-8 space-y-3">
        ...
        <p className="text-brand-900/80">
          يتم التسجيل بالاسم فقط دون كلمة مرور. البريد الإلكتروني اختياري ويُستخدم فقط لاستعادة
          حسابك إذا غيّرت الجهاز أو مسحت بيانات المتصفح.
        </p>
      </section>
      ...
      <section className="mt-8 space-y-3">
        ...
        <ul className="list-inside list-disc space-y-2 text-brand-900/80">
          ...
          <li>في حال فوز أحد الفريقين وكان فرق الأهداف في توقعك أقل أو أكثر بهدف واحد بالضبط عن الفرق الفعلي: نقطتان.</li>
